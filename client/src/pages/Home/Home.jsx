...
const Home = () => {
  ...
  const seoData = {
    title: "ALMADEV - Professional Web Development Solutions",
    description:
      "ALMADEV provides professional web development solutions including full-stack development, e-commerce solutions, and educational technology platforms. Expert in React, Node.js, and modern web technologies.",
    keywords:
      "web development, full stack developer, react, node.js, e-commerce, educational technology, MERN stack",
    ogImage: "https://jadidalmargibi.com/og-image.jpg",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "Organization",
      name: "ALMADEV",
      description: "Professional Web Development Solutions",
      url: "https://jadidalmargibi.com",
      logo: "https://jadidalmargibi.com/logo.png",
      sameAs: [
        "https://github.com/yourgithub",
        "https://linkedin.com/company/yourcompany",
      ],
      offers: projects.map((project) => ({
        "@type": "Service",
        name: project.title,
